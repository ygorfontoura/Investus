            ...
            <div class="form-group">
                <div class="row align-content-center justify-content-between">
                    ...
                    <div class="row mr-auto ">
                        ...
                        <div class="col-md-4">
                            <input class="col-lg-12 input-lg mt-1 mb-2" type="text" name="ccard" pattern="[0-9]{16}" title="Invalid Credit Card number" placeholder="<?=(isset($user_account['ccard'])) ? "XXXXXXXX".str_split($user_account['ccard'], 8)[1] : ""?>">
                        </div>
                        <div class="col-md-1">
                            <label>CSC: </label>
                        </div>
